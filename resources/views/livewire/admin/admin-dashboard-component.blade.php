<div class="container w-full mx-auto pt-20">
    ...
    <div class="w-full px-4 md:px-0 md:mt-8 mb-16 text-gray-800 leading-normal" style="margin-top: 100px;">
        <div class="w-full p-3">

            <div class="bg-gray-900 border border-gray-800 rounded shadow">
                <div class="border-b border-gray-800 p-3">
                    <h5 class="font-bold uppercase text-gray-600">Components</h5>
                    <button
                        class="bg-blueGray-500 text-white active:bg-blueGray-600 font-bold uppercase text-xs px-4 py-2 rounded-full shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                        type="button"><a href="{{ route('admin.faq') }}">
                            <i class="far fa-question-circle"></i> Faqs</a>
                    </button>

                    <button
                        class="bg-blueGray-500 text-white active:bg-blueGray-600 font-bold uppercase text-xs px-4 py-2 rounded-full shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                        type="button"><a href="{{ route('admin.articles') }}">
                            <i class="fas fa-newspaper"></i> Articles</a>
                    </button>

                    <button
                        class="bg-blueGray-500 text-white active:bg-blueGray-600 font-bold uppercase text-xs px-4 py-2 rounded-full shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                        type="button"><a href="{{ route('admin.portfolios') }}">
                            <i class="fas fa-briefcase"></i> Portfolios</a>
                    </button>

                    <button
                        class="bg-blueGray-500 text-white active:bg-blueGray-600 font-bold uppercase text-xs px-4 py-2 rounded-full shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                        type="button"><a href="{{ route('admin.newsletter') }}">
                            <i class="fas fa-rss-square"></i> Newsletter</a>
                    </button>

                    <button
                        class="bg-blueGray-500 text-white active:bg-blueGray-600 font-bold uppercase text-xs px-4 py-2 rounded-full shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                        type="button"><a href="{{ route('admin.testimonials') }}">
                            <i class="fas fa-envelope-open-text"></i> Testimonials</a>
                    </button>

                    <button
                        class="bg-blueGray-500 text-white active:bg-blueGray-600 font-bold uppercase text-xs px-4 py-2 rounded-full shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                        type="button"><a href="{{ route('admin.contact') }}">
