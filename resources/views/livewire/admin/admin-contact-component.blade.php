            ...
            <div class="w-full p-3">
                ...
                <div class="bg-gray-900 border border-gray-800 rounded shadow">
                    <div class="border-b border-gray-800 p-3">
                        <h5 class="font-bold uppercase text-gray-600">All Contacts</h5>
                            ...
                            <table class="table table-striped w-full p-5 text-gray-700">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left text-gray-600">Subject</th>
                                        <th class="text-left text-gray-600">Message</th>
                                        <th class="text-left text-gray-600">Completed</th>
                                        <th class="text-left text-gray-600">Sent On</th>
