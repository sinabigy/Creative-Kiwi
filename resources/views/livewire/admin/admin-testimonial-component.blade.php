...
">
            <div class="w-full p-3">
                ...
                <button
                    ...
                    <a href="{{route('admin.addtestimonial')}}">Add New</a>
                </button>

                <div class="bg-gray-900 border border-gray-800 rounded shadow">
                    <div class="border-b border-gray-800 p-3">
                        <h5 class="font-bold uppercase text-gray-600">All Testimonials</h5>
                                ...
                                <tbody>
                                    @foreach ($testimonials as $testimonial)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('admin.edittestimonial',['testimonial_slug'=>$testimonial->slug])}}"><i class="fa fa-edit fa-2x text-info"></i></a>
                                                <a href="#" style="margin-left: 10px;" wire:click.prevent="deleteTestimonial({{$testimonial->id}})"><i class="fa fa-times fa-2x text-danger"></i></a>
                                            </td>
                                        </tr> 
                                    @endforeach
                                </tbody>
