...
">
            <div class="w-full p-3">
                ...
                <button
                    ...
                    <a href="{{route('admin.addportfolio')}}">Add New</a>
                </button>

                <div class="bg-gray-900 border border-gray-800 rounded shadow">
                    <div class="border-b border-gray-800 p-3">
                        <h5 class="font-bold uppercase text-gray-600">All Portfolios</h5>
                                ...
                                <tbody>
                                    @foreach ($portfolios as $porfolio)
                                        <tr>
                                            ...
                                            <td>{{$porfolio->created_at}}</td>
                                            <td>
                                                <a href="{{route('admin.editportfolio',['portfolio_slug'=>$porfolio->slug])}}"><i class="fa fa-edit fa-2x text-info"></i></a>
                                                <a href="#" style="margin-left: 10px;" wire:click.prevent="deletePortfolio({{$porfolio->id}})"><i class="fa fa-times fa-2x text-danger"></i></a>
                                            </td>
                                        </tr> 
                                    @endforeach
                                </tbody>
